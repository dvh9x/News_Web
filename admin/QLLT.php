...
{
	$id=intval($_GET['scid']);
	$query=mysqli_query($con,"update  loaitin set AnHien='0' where idLT='$id'");
	$msg="Xóa Thành Công !! ";
}
// Code for restore
if($_GET['resid'])
{
	...
	$query=mysqli_query($con,"update  loaitin set AnHien='1' where idLT='$id'");
...
{
	$id=intval($_GET['scid']);
	$query=mysqli_query($con,"delete from   loaitin  where idLT='$id'");
...
<button id="addToTable" class="btn btn-success waves-effect waves-light">Thêm <i class="mdi mdi-plus-circle-outline" ></i></button>
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select theloai.TenTL as catname,loaitin.Ten as subcatname,loaitin.idLT as subcatid from loaitin join theloai on loaitin.idTL=theloai.idTL where loaitin.AnHien=1");
$cnt=1;
...
<td><a href="SuaLT.php?scid=<?php echo htmlentities($row['subcatid']);?>"><i class="fa fa-pencil" style="color: #29b6f6;"></i></a> 
...
<div class="table-responsive">
   <table class="table m-0 table-colored-bordered table-bordered-danger">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select theloai.TenTL as catname,loaitin.Ten as subcatname,loaitin.idLT as subcatid from loaitin join theloai on loaitin.idTL=theloai.idTL where loaitin.AnHien=0");
$cnt=1;
$rowcount=mysqli_num_rows($query);
if($rowcount==0)
{
