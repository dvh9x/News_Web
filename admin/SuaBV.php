...
$query=mysqli_query($con,"update tin set TieuDe='$posttitle',idTL='$catid',idLT='$subcatid',AnHien='$status' where idTin='$postid'");
if($query)
{
$msg="Post updated ";
}
...
<?php
$postid=intval($_GET['pid']);
$query=mysqli_query($con,"select tin.idTin as postid,tin.urlHinh,tin.TieuDe as title,theloai.TenTL as category,theloai.idTL as catid,loaitin.idLT as subcatid,loaitin.Ten as subcategory from tin left join theloai on theloai.idTL=tin.idTL left join loaitin on loaitin.idLT=tin.idLT where tin.idTin='$postid' and tin.AnHien=1 ");
...
<img src="../upload/tintuc/<?php echo htmlentities($row['urlHinh']);?>" width="300"/>
<br />
