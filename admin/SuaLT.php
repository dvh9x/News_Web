...
$query=mysqli_query($con,"update loaitin set idTL='$categoryid',Ten='$subcatname' where idLT='$subcatid'");
if($query)
{
...
$subcatid=intval($_GET['scid']);
$query=mysqli_query($con,"Select theloai.TenTL as catname,theloai.idTL as catid,loaitin.Ten as subcatname,loaitin.idLT as subcatid from loaitin join theloai on loaitin.idTL=theloai.idTL where loaitin.AnHien=1 and  idLT='$subcatid'");
$cnt=1;
